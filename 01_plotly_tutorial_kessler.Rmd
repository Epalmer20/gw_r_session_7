...
plot_ly(data=df, x = ~month, y = ~Vegetable, name = 'Vegetable', 
  ...
  layout(title = "Average Sales by Parts of Supermarkets",
...
#Data Visualization
fig <- new_df_counted %>% plot_ly(x = ~cut, 
                                  y = ~n, 
                                  color = ~clarity)
